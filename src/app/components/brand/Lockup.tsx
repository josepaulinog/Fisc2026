...
export function IconMark({
  ...
  return (
    ...
    >
      <g fill="currentColor">
        <path d="M0,25.34v-11.26C0,6.08,6.42,0,14.42,0h29.62c.79,0,1.46.34,2.03,1.01l5.29,6.42c.79.9.79,2.14,0,3.04l-5.29,6.42c-.56.9-1.35,1.46-2.48,1.46H12.84c-5.97,0-10.14,3.04-12.84,6.98Z" />
        <path d="M0,46.85v-13.51c0-6.53,5.63-11.49,12.84-11.49h21.06c1.01,0,1.91.45,2.59,1.24l5.18,6.19c.9,1.01.9,2.25,0,3.27l-5.18,6.19c-.68.79-1.58,1.24-2.59,1.24H12.84c-5.97,0-10.14,2.93-12.84,6.87Z" />
        <circle cx="9.46" cy="53.05" r="8.67" />
      </g>
    </svg>
  );
}
